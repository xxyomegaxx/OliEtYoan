...
/*
 * Repr�sente un utilisateur (humain ou robot).
 * L'utilisateur initialise un panneau d'interface, mais l'ajout de celui-ci � l'arri�re-plan
 * est contr�l� ailleurs (Session).
 */

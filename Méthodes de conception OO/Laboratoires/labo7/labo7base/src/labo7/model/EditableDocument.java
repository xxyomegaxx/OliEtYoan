...
/*
 * Repr�sente le mod�le sur lequel l'interface veut faire des modifications.
 * Le mod�le est actuellement un document de texte simple avec un presse-papiers
 * (clipboard) et un mode d'insertion (lorsqu'on colle, on �crase ou non?)
